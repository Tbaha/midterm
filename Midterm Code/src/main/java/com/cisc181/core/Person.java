...
public abstract class Person implements java.io.Serializable {
			...
			Date DOB, String Address, String Phone_number, String Email) throws PersonException
	{
		...
		this.LastName = LastName;
		this.setDOB(DOB);
		Date OverHundred = new Date(1900, 1, 14);
		if(DOB.before(OverHundred)) {
		throw new PersonException("DOB is Over Hundred years old", this);
		}
		...
		if(matcher.matches()){	
			...
			throw new PersonException("Phone number is not in correct format", this);
		}
	}
